...
int main()
{
    ...
    {
        cout << "Options: " << endl;
        cout << "\nTo append new item info into the linked list input 1";
        cout << "\nTo add new item info into any position of the linked list input 2";
        cout << "\nTo delete item info from linked list using index no. input 3";
        cout << "\nTo delete item info from linked list using item name input 4";
        cout << "\nTo enqueue a request input 5";
        cout << "\nTo start selling as per customer requests input 6";
        cout << "\nTo display all requests stored in queue input 7";
        cout << "\nTo display all item information stored in the linked list input 8";
        cout << "\nTo edit item information in linked list input 9";
        ...
        cout << "\nTo save all info in file input 13";
